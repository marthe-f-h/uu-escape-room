				...
				<div className="ml-4">
					{activeStep === 1 && (
						<div className="flex flex-col gap-4">
							...
							>
								<Radio value={t.step1.test1.alt1}>
									{t.step1.test1.alt1}
								</Radio>
								<Radio value={t.step1.test1.alt2}>
									{t.step1.test1.alt2}
								</Radio>
								<Radio value={t.step1.test1.alt3}>
									{t.step1.test1.alt3}
								</Radio>
							</RadioGroup>

							<CheckboxGroup
								legend={t.step1.test2.label}
								size="small"
							>
								<Checkbox value={t.step1.test2.alt1}>
									{t.step1.test2.alt1}
								</Checkbox>
								<Checkbox value={t.step1.test2.alt2}>
									{t.step1.test2.alt2}
								</Checkbox>
								<Checkbox value={t.step1.test2.alt3}>
									{t.step1.test2.alt3}
								</Checkbox>
							</CheckboxGroup>
					...
					{activeStep === 3 && (
						<div className="flex flex-col gap-4">
							...
							<Heading className="sr-only" size="small" level="2">
